  ...
  async function submit(event: React.FormEvent) {
    void fetch("/api/events", {
      ...
      body: JSON.stringify({
        ...
        metadata: { assessmentId: "personality-dna" }
      })
    });
    ...
    window.localStorage.setItem("vibelytix-premium-payment-v1", JSON.stringify(nextPayment));
  ...
  return (
    <div className="premium-checkout">
      <div className="checkout-head">
        ...
        <h2>Unlock the complete Personality DNA report.</h2>
